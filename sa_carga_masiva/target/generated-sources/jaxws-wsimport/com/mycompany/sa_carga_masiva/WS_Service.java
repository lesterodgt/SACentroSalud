 ...
 * 
 */
@WebServiceClient(name = "WS", targetNamespace = "http://ws_centro_salud_2.sa/", wsdlLocation = "http://localhost:8080/WS_CENTRO_SALUD_2/WS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WS_QNAME = new QName("http://ws_centro_salud_2.sa/", "WS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS_CENTRO_SALUD_2/WS?WSDL");
    ...
    public WS getWSPort() {
        return super.getPort(new QName("http://ws_centro_salud_2.sa/", "WSPort"), WS.class);
    }
    ...
    public WS getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws_centro_salud_2.sa/", "WSPort"), WS.class, features);
    }
